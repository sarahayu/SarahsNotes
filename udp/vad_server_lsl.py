...
from pylsl import StreamInlet, resolve_stream, proc_threadsafe
...
class SynetheticAudio(object):
    ...
    def __init__(self, frames_queue, input_rate=RATE_PROCESS, file=None):
        ...
        self.block_size = int(RATE_PROCESS / float(BLOCKS_PER_SECOND))
    ...
    def resample(self, data, input_rate):
        ...
        resample_size = int(len(data16) / self.input_rate * RATE_PROCESS)
